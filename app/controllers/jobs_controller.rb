...
0.1  0.2  0.3");
  ...
  def generate
    ...
    if (@job.state_space)
        ...
        @error_message = `perl public/perl/dvd_stochastic_runner.pl -v #{@job.nodes} 2 1 0 public/perl/#{@file_prefix}   #{@job.state_space_format} 1 0 0 1 1 0 #{@functionfile_name}`; 
