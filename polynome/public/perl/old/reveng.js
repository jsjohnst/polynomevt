...
messages[0] = new Array('This is the number <b><i>n</i></b> of nodes in your discrete dynamical system.',"#DDECFF");
messages[1] = new Array('This specifies the type of data.  Select <b>Continuous</b> if the data are rational or real numbers.  Otherwise, select <b>Discrete</b>. In this case, enter the total number of labels or states.',"#DDECFF");
